...
$pageName = "Mengenal Tag, Element, dan Atribut HTML";
$name = "html";
$login = true;
...
<body>
  ...
  <section class="html">
    <div class="container">
      <h2>3. Mengenal Tag, Element, dan Atribut HTML</h2>
      <hr>
      <p>Dalam HTML, tag, elemen, dan atribut adalah komponen penting yang digunakan untuk membangun struktur dan mengatur konten dalam halaman web. Berikut adalah penjelasan singkat tentang masing-masing:</p>
      <p>1. Tag HTML: <br>
            Tag HTML adalah elemen dasar dalam HTML dan digunakan untuk membungkus dan mengelompokkan konten dalam sebuah dokumen. Tag HTML terdiri dari tanda kurung sudut (<>) yang mengapit nama tag. Misalnya, tag &lt;h1&gt; digunakan untuk menandai judul utama dalam dokumen HTML.</p>
      <p>2. Elemen HTML: <br>
      Elemen HTML terdiri dari pasangan tag pembuka dan penutup yang membungkus konten. Tag pembuka ditempatkan sebelum konten, sementara tag penutup ditempatkan setelah konten. Elemen HTML mengindikasikan tipe konten dan memberikan struktur pada dokumen. Misalnya, elemen &lt;p&gt; digunakan untuk menandai paragraf teks dalam dokumen HTML.</p>
      <p>3. Atribut HTML: <br>
      Atribut HTML memberikan informasi tambahan tentang elemen HTML dan ditambahkan ke dalam tag pembuka. Mereka terdiri dari nama dan nilai, dipisahkan oleh tanda sama dengan (=). Atribut digunakan untuk mengontrol perilaku atau tampilan elemen. Sebagai contoh, atribut &lt;href&gt; digunakan dalam elemen &lt;a&gt; untuk menentukan URL yang akan dibuka ketika tautan tersebut diklik.</p>
      <p>Contoh penggunaan tag, elemen, dan atribut dalam HTML:</p>
<pre>
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
&lt;body&gt;
  ...
  &lt;a href="https://www.contoh.com"&gt;Kunjungi Contoh&lt;/p&gt;
&lt;/body&gt;
&lt;/html&gt;
</pre> <br>
      <p>Dalam contoh di atas, &lt;html&gt;, &lt;head&gt;, &lt;title&gt;, &lt;body&gt;, &lt;h1&gt;, &lt;p&gt;, dan &lt;a&gt; adalah tag HTML. &lt;h1&gt;, &lt;p&gt;, dan &lt;a&gt; adalah elemen HTML. Atribut &lt;href&gt; digunakan dalam elemen &lt;a&gt; untuk menentukan URL tujuan.</p>
    </div>
    <div class="html-list">
      <h2>HTML</h2>
      <hr>

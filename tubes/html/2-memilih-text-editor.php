...
<body>
  ...
  <section class="html">
    <div class="container">
      <h2>2. Memilih Text Editor</h2>
      <p>Untuk anda yang baru mau belajar bahasa pemrograman, disini khususnya pemrograman web tentulah berfikir bagaimana saya membuat, dan apa yang harus saya gunakan untuk membuat program ? berikut kami sediakan jawaban yang mungkin terbesit dalam hati/pikiran anda yang baru mau belajar bahasa pemrograman. sebelum kita memulai cara penulisan HTML terlebih dahulu yang harus anda sediakan adalah text editor dan browser</p>
      <p>Text editor adalah sebuah perangkat lunak yang digunakan untuk membuat, mengedit, dan mengelola file teks. Text editor memungkinkan pengguna untuk melakukan tugas-tugas seperti menulis kode program, membuat dan mengedit dokumen teks, mengubah format dan tata letak teks, dan melakukan operasi lainnya terkait teks.</p>
      <p>Text editor umumnya menyediakan fitur-fitur seperti penyorotan sintaks, yang membedakan antara elemen-elemen bahasa pemrograman yang berbeda, dan kemudahan navigasi melalui dokumen. Beberapa text editor juga menyediakan fitur-fitur lanjutan seperti intellisense (saran otomatis), debugging, integrasi dengan sistem pengontrol versi, dan dukungan untuk penggunaan ekstensi atau plugin untuk memperluas fungsionalitasnya.</p>
      <p>Text editor dapat digunakan oleh berbagai jenis pengguna, termasuk pengembang perangkat lunak, penulis, administrator sistem, dan pengguna biasa yang hanya perlu mengedit dan mengelola file teks. Beberapa text editor dirancang untuk tugas-tugas khusus, seperti pengembangan web atau analisis data, sementara yang lain dirancang untuk menjadi lebih umum dan dapat digunakan dalam berbagai konteks.</p>
      <p>Dalam beberapa kasus, text editor juga dapat merujuk kepada editor teks yang disediakan sebagai bagian dari lingkungan pengembangan terintegrasi (IDE) yang lebih besar, yang biasanya menawarkan fitur-fitur tambahan seperti kompilasi, debug, dan manajemen proyek. Contoh IDE yang menggabungkan text editor termasuk Visual Studio, Eclipse, dan PyCharm.</p>
    </div>
    <div class="html-list">
      <h2>HTML</h2>
      <hr>

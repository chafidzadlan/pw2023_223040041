...
<body>
  ...
  <section class="html">
    <div class="container">
      ...
      <hr>
      <p>HTML (Hypertext Markup Language) adalah singkatan dari bahasa pemrograman yang digunakan untuk membuat dan mengatur struktur konten sebuah halaman web. HTML menggunakan tag-tag (elemen) untuk memberi tahu browser bagaimana menampilkan elemen-elemen konten seperti teks, gambar, tautan, tabel, formulir, dan lain-lain.</p> 
      <p>Dengan menggunakan tag-tag HTML, kita dapat membuat struktur dasar halaman web dengan menentukan judul, paragraf, heading (judul bagian), daftar, pengaturan tautan, dan lainnya. Tag-tag tersebut terdiri dari pasangan tag pembuka dan penutup, dengan konten yang diletakkan di antara keduanya.</p>
      <p>Contoh sederhana kode HTML:</p> <br>
<pre>
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
&lt;/html&gt;
      ...
      <p>HTML adalah bagian penting dalam pengembangan web, dan sering digunakan bersama dengan CSS (Cascading Style Sheets) dan JavaScript untuk memberikan tampilan dan interaktivitas yang lebih canggih pada halaman web.</p>
    </div>
    <div class="html-list">
      <h2>HTML</h2>
      <hr>

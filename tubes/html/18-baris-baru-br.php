...
<body>
  ...
  <section class="html">
    <div class="container">
      <h2>18. Baris Baru (Tag BR)</h2>
      <hr>
      <p>Dalam HTML, Anda dapat menggunakan tag &lt;br&gt; untuk membuat baris baru atau garis pindah (line break). Berikut adalah contoh penggunaan tag &lt;br&gt;:</p>
<pre>
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
&lt;body&gt;
  ...
  Baris ini akan berada dalam baris baru.&lt;/p&gt;

  &lt;p&gt;Ini adalah paragraf ketiga.&lt;/p&gt;
&lt;/body&gt;
&lt;/html&gt;
</pre>
      <p>Pada contoh di atas, setelah paragraf kedua, &lt;br&gt; digunakan untuk membuat baris baru. Dalam hal ini, teks "Baris ini akan berada dalam baris baru." akan ditampilkan pada baris baru.</p>
      <p>Anda dapat menggunakan tag &lt;br&gt; setiap kali Anda ingin membuat baris baru dalam konten HTML Anda.</p>
    </div>
    <div class="html-list">
      <h2>HTML</h2>
      <hr>

...
<body>
  ...
  <section class="html">
    <div class="container">
      <h2>6. Paragraf HTML</h2>
      <hr>
      <p>Dalam HTML, elemen &lt;p&gt; digunakan untuk mengelompokkan teks dalam sebuah paragraf. Ini memberikan jarak antara paragraf secara default. Berikut adalah contoh penggunaan elemen &lt;p&gt;:</p>
<pre>
&lt;p&gt;Ini adalah contoh paragraf.&lt;/p&gt;
&lt;p&gt;Ini adalah paragraf lainnya.&lt;/p&gt;
</pre>
      <p>Pada contoh di atas, dua paragraf terpisah dibuat menggunakan elemen &lt;p&gt;. Setiap paragraf akan ditampilkan sebagai blok teks terpisah dengan jarak antara satu sama lain.</p>
      <p>Anda juga dapat memformat teks dalam paragraf menggunakan elemen dan atribut lain. Misalnya, untuk membuat teks tebal dalam paragraf:</p>
<pre>
&lt;p&gt;Ini adalah &lt;strong&gt;teks tebal&lt;/strong&gt; dalam paragraf.&lt;/p&gt;
</pre>
      <p>Hasilnya akan menjadi: "Ini adalah <strong>teks tebal</strong> dalam paragraf."</p>
      <p>Anda dapat menambahkan sejauh mungkin paragraf dalam dokumen HTML Anda, baik untuk membagi konten atau mengatur informasi dalam kelompok paragraf yang terkait.</p>
    </div>
    <div class="html-list">
      <h2>HTML</h2>
      <hr>

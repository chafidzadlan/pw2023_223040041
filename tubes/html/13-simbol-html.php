...
<body>
  ...
  <section class="html">
    <div class="container">
      <h2>13. Simbol HTML</h2>
      <hr>
      <p>Dalam HTML, ada beberapa simbol atau karakter khusus yang memiliki representasi khusus menggunakan kode simbol HTML atau entity HTML. Simbol-simbol ini digunakan ketika Anda ingin menampilkan karakter khusus seperti simbol mata uang, simbol matematika, tanda baca, atau karakter dengan kode ASCII yang tidak terlihat atau tidak dapat direpresentasikan langsung dalam kode HTML. Berikut adalah beberapa contoh simbol HTML yang umum digunakan:</p>
      <p>1. Simbol Mata Uang: <br>
        - Dollar: $  <br>
        - Euro: €  <br>
        - Pound Sterling: £  <br>
        - Yen: ¥  
      </p>
      <p>2. Simbol Matematika: <br>
        - Tanda Pi: π ; <br>
        - Tanda Infinity: ∞  <br>
        - Tanda Akar Kuadrat: √ 
      </p>
      ...
      <p>4. Karakter Khusus Lainnya: <br>
        - Tanda Panah Kanan: → <br>
        - Tanda Bintang: ∗ <br>
        - Tanda Tanya Hitam: &blackquestion; 
      </p>
      <p>Ini hanya beberapa contoh simbol HTML yang umum digunakan. Anda dapat mencari daftar lengkap simbol HTML dan entitas HTML di banyak sumber online yang menyediakan referensi karakter HTML.</p>
    </div>
    <div class="html-list">
      <h2>HTML</h2>
      <hr>

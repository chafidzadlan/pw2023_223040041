...
$pageName = "Menampilkan gambar HTML";
$name = "html";
$login = true;
...
<body>
  ...
  <section class="html">
    <div class="container">
      <h2>14. Menampilkan Gambar HTML</h2>
      <hr>
      <p>Untuk menampilkan gambar dalam HTML, Anda dapat menggunakan elemen &lt;img&gt;. Berikut adalah contoh penggunaan elemen &lt;img&gt;:</p>
<pre>
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
&lt;/html&gt;
      ...
      <p>- `src`: Atribut `src` digunakan untuk menentukan sumber atau path gambar yang akan ditampilkan. Anda perlu menggantinya dengan path yang benar menuju gambar yang ingin Anda tampilkan. Misalnya, jika gambar berada dalam folder yang sama dengan halaman HTML, Anda dapat menggunakan nama gambar dan ekstensi, seperti `src="gambar.jpg"`. Jika gambar berada di URL eksternal, Anda dapat menggunakan URL lengkapnya, seperti `src="https://www.example.com/gambar.jpg"`.</p>
      <p>- `alt`: Atribut `alt` digunakan untuk memberikan deskripsi alternatif untuk gambar. Deskripsi ini akan ditampilkan jika gambar gagal dimuat atau jika pengguna menggunakan pembaca layar. Penting untuk memberikan deskripsi yang relevan untuk meningkatkan aksesibilitas dan pengalaman pengguna.</p>
    </div>
    <div class="html-list">
      <h2>HTML</h2>
      <hr>

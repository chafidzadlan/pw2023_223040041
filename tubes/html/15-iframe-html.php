...
<body>
  ...
  <section class="html">
    <div class="container">
      <h2>15. IFrame HTML</h2>
      <hr>
      <p>IFrame (Inline Frame) adalah elemen HTML yang digunakan untuk menyisipkan konten dari sumber eksternal ke dalam halaman HTML. Dengan menggunakan IFrame, Anda dapat menampilkan halaman web, video, atau konten lainnya dari sumber yang berbeda dalam halaman HTML utama. Berikut adalah contoh penggunaan IFrame dalam HTML:</p>
<pre>
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
&lt;/html&gt;
      ...
      <p>Penjelasan tentang atribut yang digunakan dalam contoh di atas:</p>
      <p>- `src`: Atribut `src` digunakan untuk menentukan URL atau alamat dari konten yang akan ditampilkan dalam IFrame. Anda perlu menggantinya dengan URL yang tepat ke halaman web atau sumber konten eksternal lainnya.</p>
      <p>- `width` dan `height`: Atribut `width` dan `height` digunakan untuk menentukan lebar dan tinggi IFrame dalam piksel. Anda dapat menyesuaikan nilai-nilai ini sesuai dengan kebutuhan tata letak dan ukuran yang diinginkan.</p>
      <p>- `frameborder`: Atribut `frameborder` digunakan untuk mengontrol tampilan bingkai atau border di sekitar IFrame. Nilai "0" akan menghilangkan border, sedangkan nilai "1" akan menampilkan border.</p>
      <p>IFrame memungkinkan Anda untuk menggabungkan konten dari sumber eksternal ke dalam halaman HTML Anda. Pastikan untuk menggunakan IFrame hanya dengan konten yang dapat dipercaya, karena IFrame juga dapat digunakan untuk menyisipkan konten berbahaya.</p>
    </div>
    <div class="html-list">
      <h2>HTML</h2>
      <hr>

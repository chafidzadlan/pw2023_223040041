...
<body>
  ...
  <section class="html">
    <div class="container">
      <h2>8. Link Hyperlink HTML</h2>
      <hr>
      <p>Untuk membuat hyperlink dalam HTML, Anda dapat menggunakan elemen &lt;a&gt; dengan atribut &lt;href&gt;. Berikut contoh bagaimana membuat hyperlink sederhana:</p>
<pre>
&lt;a href="https://www.contoh.com"&gt;Klik di sini&lt;/a&gt;
</pre>
      <p>Pada contoh di atas, teks "Klik di sini" akan ditampilkan sebagai hyperlink, dan ketika diklik, akan membuka URL yang ditentukan dalam atribut &lt;href&gt;  (dalam hal ini, "https://www.contoh.com").</p>
      <p>Anda juga dapat menggunakan URL relatif untuk membuat tautan internal di dalam situs web Anda. Berikut contohnya:</p>
<pre>
&lt;a href="/tentang"&gt;Tentang&lt;/a&gt;
</pre>
      <p>Dalam contoh ini, saat mengklik tautan "Tentang", pengguna akan diarahkan ke halaman "/tentang" relatif terhadap URL halaman saat ini.</p>
      <p>Selain itu, Anda dapat menggunakan atribut `target` untuk menentukan bagaimana tautan harus dibuka. Misalnya, untuk membuka tautan di tab atau jendela baru, Anda dapat menggunakan:</p>
<pre>
&lt;a href="https://www.contoh.com" target="_blank"&gt;Klik di sini&lt;/a&gt;
</pre>
      <p>Atribut `target="_blank"` memberitahu browser untuk membuka tautan di tab atau jendela baru.</p>
      <p>Ingatlah untuk menyertakan URL lengkap, termasuk protokol (misalnya, "http://" atau "https://"), ketika membuat tautan ke situs web eksternal.</p>
    </div>
    <div class="html-list">
      <h2>HTML</h2>
      <hr>
